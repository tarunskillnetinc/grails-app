...
class Product {
    ...
    static constraints = {
        itemCode size: 1..50, blank: false, nullable: false, validator: { val, obj ->
            return countByRetailerIdAndItemCodeAndIdNotEqual(obj.retailerId, obj.itemCode, obj.id) > 0 ? true : ["error.product.duplicateItemCode"]
        }
