...
<div id="search-results">
    ...
    <g:each in="${members}" var="member" status="i">
        <div id="member-result-${i+1}" class="row ml-0 mr-0 pt-2 pb-2 wl-striped${i%2} hoverable" title="Click to view." style="cursor: pointer;" onclick="document.location.href='${createLink(action:'show', params:[cardNumber: member.cardNumber])}';">
