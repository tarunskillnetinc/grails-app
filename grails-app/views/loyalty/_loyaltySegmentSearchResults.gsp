...
<div class="my-3 text-right">
    <util:remotePaginate action="ajaxSearchLoyaltySegment" total="${totalResults ?: 0}" update="results-container" offset="${offset ?: 0}" max="${max ?: 50}" params="[loyaltySegmentTerm: loyaltySegmentTerm, loyaltySegmentSearchBy: loyaltySegmentSearchBy]" />
</div>