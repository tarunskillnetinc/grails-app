        ...
        <section>
            ...
            <g:form method="post" action="ajaxSaveMemberOffer" class="mt-4" name="saveMemberOffer">
                ...
                <div class="tab-content">
                    <div class="row my-3">
                        <g:link elementId="memberOfferSave-cancel" class="btn btn-wl col-1 offset-1" action="offers" params="[cardNumber: cardNumber]" onClick="return confirm('Any unsaved changes will be lost, ar you sure you wish to continue?');">Cancel</g:link>
