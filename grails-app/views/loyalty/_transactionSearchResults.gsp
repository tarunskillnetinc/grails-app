...
<div id="search-results">
    ...
    <g:each in="${transactions}" var="transaction" status="i">
        <div id="transaction-result-${i+1}" class="row ml-0 mr-0 pt-2 pb-2 wl-striped${i%2} hoverable" title="Click to view." style="cursor: pointer;" onclick="document.location.href='${createLink(action:'transactionDetails', params:[memberId: transaction.memberId, transactionId: transaction.transactionId])}';" >
