...
<section class="mt-1 pt-5">
    <g:form method="post" action="processPaidOut" class="mt-1" name="processPaidOut">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-lg-5 offset-md-1">
                    <div class="form-group mb-5">
                        <div class="d-flex align-items-center">
                            <label for="safeId" class="col-form-label mb-0 mr-2" style="width: 6.2rem;">Safe</label>
                    ...
                    <div class="form-group mb-5">
                        <div class="d-flex align-items-center">
                            <label for="tender" class="col-form-label mb-0 mr-2" style="width: 6.2rem;">Tender</label>
                            <div class="flex-grow-1" style="max-width: 15rem;">
                    ...
                    <div class="form-group mb-5">
                        <div class="d-flex align-items-center">
                            <label for="reasonCode" class="col-form-label mb-0 mr-2" style="width: 6.2rem;">Reason code</label>
                            <div class="flex-grow-1" style="max-width: 15rem;">
                    ...
                    <div class="form-group mb-5">
                        <div class="d-flex align-items-center">
                            <label for="amount" class="col-form-label mb-0 mr-2" style="width: 6.2rem;">Amount</label>
                            <div class="flex-grow-1" style="max-width: 15rem;">
                    ...
                    <div class="mt-5 d-flex justify-content-end" style="max-width: 20.5rem;">
                        <button id="tender-lift-cancel" type="button" name="safe-cancel-button" onclick="handleCancelTenderLift('${createLink(action:'/home')}')" class="btn btn-wl mr-2">Cancel</button>
