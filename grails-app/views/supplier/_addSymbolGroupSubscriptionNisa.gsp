...
<div class="row mt-5 col-10 offset-1">
    ...
    <div>A supplier affiliation allows you to receive product and promotion files from Nisa which is updated by them on an ongoing basis. You can also place orders directly with Nisa using the Trust Retail inventory management app.</div>
</div>
...
<div class="row mt-3 col-10 offset-1">
    ...
    <div>Nothing! Adding your credentials and signing up to receive product and promotion updates are included in your Trust Retail POS package at no extra cost.</div>
</div>
