...
<div class="row ml-0 mr-0 pt-2 pb-2 ${(i != null) ? 'wl-striped' + (i%2) : ''}" id="productVariant${productVariant?.id}">
    ...
    <div id="prod-${pos}-id" class="col-1 my-auto">${productVariant?.id}</div>
    ...
    <div id="prod-${pos}-colour" class="col-1 my-auto">${productVariant?.colour ?: 'N/A'}</div>
    <div id="prod-${pos}-size" class="col-1 my-auto">${productVariant?.size ?: 'N/A'}</div>
