...
<head>
    ...
    <script type="application/javascript">
        ...
        function search() {
            ...
            $.ajax({
                url: url,
                data: { searchTerm: searchTerm, categoryCode: categoryCode },
...
<body>
            ...
            <div class="row mt-4">
                <div class="col">
                    <ol class="breadcrumb">
                        ...
                        <li id="breadcrumb-2" class="breadcrumb-item active" aria-current="page">Category Management</li>
                    </ol>
                </div>
            </div>
        </nav>
    ...
    <section id="categoryManagement" class="container-fluid">
        <div class="row header-wl mt-3">
            <div class="col-8 offset-2">
                <h2 id="page-title" class="mx-auto">Category Management</h2>
            </div>
