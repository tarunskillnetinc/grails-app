                ...
                <div class="card-body collapse" id="columnsCollapse">
                    <g:form name="reportColumnsForm" id="reportColumnsForm">
                        ...
                        <div class="form-group form-check">
                            ...
                            <label class="form-check-label" for="columnsCurrentSell">Current Sell</label>
                        </div>
                        ...
                        <div class="form-group form-check">
                            ...
                            <label class="form-check-label" for="columnsDeliveryQuantity">Delivery Quantity</label>
                        </div>

                        <div class="form-group form-check">
                            <g:checkBox name="columns" id="columnsPackSize" class="form-check-input"
                                        value="totalQuantity"
                                        checked="${!userColumns || userColumns?.columns?.find { it.column == 'totalQuantity' }?.enabled}"/>
                            <label class="form-check-label" for="columnsPackSize">Total Quantity</label>
                        </div>
