...
<head>
    ...
    <script type='text/javascript'>
        ...
        var getDataUrl = "${createLink(controller: 'reporting', action: 'ajaxDeliveryCage')}";
        ...
        $(document).ready(function () {
            $("#cageBarcodeFilter").keydown(function (event) {
                if (event.keyCode === 13) {
        ...
        function resetForm() {
            document.getElementById('cageBarcodeFilter').value = "";
        }
...
<section id="reporting-container" class="container-fluid">
    <g:reportBreadcrumb reportType="${reportType}" supplierName="${delivery?.supplierReference}"
                        deliveryDate="${delivery?.dateStarted}" supplierId="${supplierId}" storeId="${storeId}"
                ...
                <div class="card-body collapse" id="filterCollapse">
                    <g:form name="filtersForm" id="filtersForm">
                        ...
                        <div class="form-group row">
                            <label for="cageBarcodeFilter"
                                   class="col-2 col-form-label-sm text-right">Cage Barcode</label>

                            <div class="col-10">
                                <g:textField id="cageBarcodeFilter" name="cageBarcodeFilter" maxlength="100"
                                             value="${cageBarcodeFilter}" class="form-control bottom-border"
                                             autocomplete="off"/>
                            </div>
                        </div>
        ...
        <div class="col-lg-3 offset-lg-2 col-md-3 text-right" style="margin-top: 8px;">
            <g:if test="${showAcceptDeliveryButton}">
                <button id="acceptDelivery" class="btn btn-warning"
                        onclick="acceptDeliveryButtonPressed();">Receipt Delivery</button>
            </g:if>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="confirmModalYesButton" class="btn btn-success"
                            onclick="acceptDelivery();">Yes</button>
                </div>
            </div>
        </div>
    </div>
