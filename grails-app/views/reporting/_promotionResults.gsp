<div class="row mt-5 pb-2 ml-0 mr-0 table-wl bottom-border">
    <g:if test="${!userColumns || userColumns?.columns?.find { it.column == "itemCode" }?.enabled}">
        <div class="col font-weight-bold"><a id="itemCode" href="#" onclick="getReportData({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'itemCode', sortOrder: ${sortParams?.sortColumn == 'itemCode' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Item Code</a></div>
    </g:if>
    ...
    <g:if test="${!userColumns || userColumns?.columns?.find { it.column == "fullPriceProfit" }?.enabled}">
        <div class="col font-weight-bold"><a id="full-price-profit" href="#" onclick="getReportData({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'fullPriceProfit', sortOrder: ${sortParams?.sortColumn == 'fullPriceProfit' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Full Price Profit</a></div>
    </g:if>
    <g:if test="${!userColumns || userColumns?.columns?.find { it.column == "fullPriceMargin" }?.enabled}">
        <div class="col font-weight-bold"><a id="full-price-margin" href="#" onclick="getReportData({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'fullPriceMargin', sortOrder: ${sortParams?.sortColumn == 'fullPriceMargin' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Full Price Margin</a></div>
    </g:if>
    ...
    <g:if test="${!userColumns || userColumns?.columns?.find { it.column == "discountedPrice" }?.enabled}">
        <div class="col font-weight-bold"><a id="discounted-price" href="#" onclick="getReportData({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'discountedPrice', sortOrder: ${sortParams?.sortColumn == 'discountedPrice' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Discounted Price</a></div>
    </g:if>
    <g:if test="${!userColumns || userColumns?.columns?.find { it.column == "discountedProfit" }?.enabled}">
        <div class="col font-weight-bold"><a id="discounted-profit" href="#" onclick="getReportData({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'discountedProfit', sortOrder: ${sortParams?.sortColumn == 'discountedProfit' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Discounted Profit</a></div>
    </g:if>
    <g:if test="${!userColumns || userColumns?.columns?.find { it.column == "discountedMargin" }?.enabled}">
        <div class="col font-weight-bold"><a id="discounted-margin" href="#" onclick="getReportData({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'discountedMargin', sortOrder: ${sortParams?.sortColumn == 'discountedMargin' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Discounted Margin</a></div>
    </g:if>
