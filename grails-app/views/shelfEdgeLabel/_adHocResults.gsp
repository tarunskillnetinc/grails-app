...
<div id="ad-hoc-results">
    ...
    <g:each in="${productLists}" var="productList" status="i">
        <div class="row col-10 offset-1 px-0 py-1 wl-striped${i%2} hoverable">
            ...
            <div id="ad-hoc-print-${i + 1}" class="col-3 my-auto"><g:select name="labelTemplate" from="${labelTemplates}" noSelection="${[0: 'Select Label']}" optionKey="id" optionValue="name" class="form-control select-border" onclick="event.stopPropagation();" onChange="adHocBatchTemplateSelected(${productList.id}, this);" /></div>
