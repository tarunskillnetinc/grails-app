...
<section id="modal-form">
        ...
        <div class="row">
            <div class="col-md-6 mt-5">
                ...
                <div class="form-group row mt-5">
                    <label for="addAmenityAvailableHours" class="col-4 col-form-label text-right" style="text-align: right; padding-right: 15px;">Available hours</label>
                    <div class="col-6" style="padding-left: 0;">
                        <!-- Grid layout for fixed positioning, aligned with Description field -->
    ...
    <div class="modal-footer">
        ...
        <button type="button" id="saveAddSupplierButton" class="btn btn-success" onclick="saveStoreAmenity();">Save</button>
    </div>
</section>