...
<head>
    ...
    <title>Trust Retail - Safe Finalisation Report</title>
    ...
    <script type='text/javascript'>
        ...
        var getSafeSessionsForSafeUrl = "${createLink(controller: 'cashReporting', action: 'ajaxGetFinalisedSafeSessionsForSafe')}";
        ...
        var getReportUrl = "${createLink(controller: 'cashReporting', action: 'ajaxGetFinalisedSafeSessionReport')}";
        function getReport() {
            storeNumber = $("#storeIdSelect").val();
            safeId = $("#safeIdSelect").val();
