...
<head>
    ...
    <title>Trust Retail - Shift Finalisation Report</title>
    ...
    <script type='text/javascript'>
        ...
        var getShiftNumbersForTillUrl = "${createLink(controller: 'cashReporting', action: 'ajaxGetFinalisedShiftsForTill')}";
        ...
        var getReportUrl = "${createLink(controller: 'cashReporting', action: 'ajaxGetFinalisedShiftReport')}";
        function getReport() {
            storeNumber = $("#storeIdSelect").val();
            tillId = $("#tillIdSelect").val();
            shiftNumber = $("#shiftNumberSelect").val();
...
<body>
    <section id="reporting-container" class="container-fluid">
        <g:render template="titleCrumbs" model="[title: 'Shift Finalisation Report']" />
