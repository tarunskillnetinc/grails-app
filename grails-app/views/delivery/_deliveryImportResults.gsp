<div class="row mt-5 pb-2 ml-0 mr-0 table-wl bottom-border">
    <div class="col-8 font-weight-bold"><a id="product-list-store-number" href="#">Order No. / Supplier Reference</a></div>
    <div class="col-2 font-weight-bold"><a id="product-list-store-name" href="#">File Status</a></div>
</div>
