<div class="category-select">
    <div class="form-group search">
        <g:textField name="category-filter-search" class="form-control bottom-border" onkeyup="searchCategories(event, ${level}, ${triggerOnCategoryChange ?: false}, this.value, ${selectedCategoryId});" placeholder="Filter categories" />
    </div>
