...
<g:each in="${promotions}" var="promotion" status="i">
    <div id="promotion-${i+1}" class="row mx-5 pt-2 pb-2 wl-striped${i % 2} hoverable" title="Click to view promotion." style="cursor: pointer;" onclick="document.location.href='${createLink(controller: 'promotion', action: 'edit', id: promotion.id)}';">
