    ...
    <g:form name="save-button" action="save" novalidate="novalidate">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group row">
                    <label for="storeName" class="col-5 col-lg-4 col-xl-3 col-form-label">Store name</label>
                ...
                <div class="form-group row">
                    <label for="addressBuildingNumberOrName" class="col-5 col-lg-4 col-xl-3 col-form-label">Building name / number</label>
                    <div class="col-7 col-lg-6">
                ...
                <div class="form-group row">
                    <label for="addressLine1" class="col-5 col-lg-4 col-xl-3 col-form-label">Address line 1</label>
                    <div class="col-7 col-lg-6">
                ...
                <div class="form-group row">
                    <label for="addressLine2" class="col-5 col-lg-4 col-xl-3 col-form-label">Address line 2</label>
                    <div class="col-7 col-lg-6">
                ...
                <div class="form-group row">
                    <label for="addressTown" class="col-5 col-lg-4 col-xl-3 col-form-label">Town / city</label>
                    <div class="col-7 col-lg-6">
                ...
                <div class="form-group row">
                    <label for="addressCounty" class="col-5 col-lg-4 col-xl-3 col-form-label">County</label>
                    <div class="col-7 col-lg-6">
                ...
                <div class="form-group row">
                    <label for="addressCountry" class="col-5 col-lg-4 col-xl-3 col-form-label">Country</label>
                    <div class="col-7 col-lg-6">
                ...
                <div class="form-group row">
                    <label for="addressPostCode" class="col-5 col-lg-4 col-xl-3 col-form-label">Post code</label>
                    <div class="col-7 col-lg-6">
                ...
                <div class="form-group row">
                    <label for="phoneNumber" class="col-5 col-lg-4 col-xl-3 col-form-label">Phone number</label>
                    <div class="col-7 col-lg-6">
