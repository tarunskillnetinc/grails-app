...
<g:each in="${signifiers}" var="signifier" status="i">
    <div class="row ml-0 mr-0 pt-2 pb-2 wl-striped${i%2} hoverable" style="cursor: pointer;" title="Click to edit." onclick="loadEditSignifier(${signifier['id']})">
        ...
        <div class="col-2 my-auto text-right" onclick="loadEditSignifier()">
