...
<div class="row mt-5 pb-2 ml-0 mr-0 table-wl bottom-border">
    <div class="col-3 font-weight-bold">
        <a id="charity-header-name" href="#" onclick="searchCharity({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'organisationName', sortOrder: ${sortParams?.sortColumn == 'organisationName' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Charity / Group Description</a>
    </div>
    <div class="col-3 font-weight-bold">
        <a id="charity-header-type" href="#" onclick="searchCharity({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'type', sortOrder: ${sortParams?.sortColumn == 'type' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Organisation Type</a>
    </div>
    <div class="col-3 font-weight-bold">
        <a id="charity-header-member-number" href="#" onclick="searchCharity({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'memberNumber', sortOrder: ${sortParams?.sortColumn == 'memberNumber' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Charity Member Number</a>
    </div>
    <div class="col-2 font-weight-bold">
        <a id="charity-header-customer-reference" href="#" onclick="searchCharity({ max: ${sortParams?.max}, offset: ${sortParams?.offset}, sortColumn: 'active', sortOrder: ${sortParams?.sortColumn == 'active' ? sortParams?.sortOrder == 'asc' ? '\'desc\'' : '\'asc\'' : '\'asc\''} });">Status</a>
    </div>
</div>
