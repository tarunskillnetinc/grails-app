        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row product-search-filters">
                    ...
                    <div class="col-2">
                        <asset:image src="search.png" id="productSearchButton" name="productSearchButton" data-url="${createLink(controller:'modal', action:'ajaxSearchProducts')}" class="wl-search-button" />
                    </div>
                </div>
                ...
                <div id="productSearchResults" class="align-content-center">
                    <g:render template="/modal/productSearchResults" model="${[ products: products ]}" />
                </div>
