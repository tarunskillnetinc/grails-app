...
class ShiftService extends MySqlDal {
    ...
    private Shift populateNewShift(int retailerId, int storeId, int tillId, boolean isAutoGenerated) throws Exception {
        ...
        addAudit(shift, ShiftAction.OPEN, isAutoGenerated) // Audit for shift open action
        return shift;
    }

    private void addAudit(Shift shift, ShiftAction shiftAction, boolean isAutoGenerated){
        try {
            ShiftAudit shiftAudit = initializeShiftAudit(shift, shiftAction, isAutoGenerated);
    ...
    private ShiftAudit initializeShiftAudit(Shift shift, ShiftAction shiftAction, boolean isAutoGenerated) {
