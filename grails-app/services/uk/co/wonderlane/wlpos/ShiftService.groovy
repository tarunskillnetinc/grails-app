...
class ShiftService extends MySqlPoolDal {
    ...
    Shift createNewShift(int retailerId, int storeId, int tillId, boolean isAutoGenerated)  {
        try {
            return saveNewShift(retailerId, storeId, tillId, isAutoGenerated)
        } catch (Exception ex) {
    ...
    private Shift saveNewShift(int retailerId, int storeId, int tillId, boolean isAutoGenerated) throws Exception {
        User loggedInUser = loadLoggedInUser()
        Shift shift = populateNewShift(retailerId, storeId, tillId, loggedInUser)
