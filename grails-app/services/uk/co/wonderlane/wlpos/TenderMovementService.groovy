...
class TenderMovementService {
    ...
    Integer tenderMovementUpdate(int tillId, int safeId, TenderMovementType tenderMovementType, Integer tenderTypeId, String tenderTypeName, BigDecimal adjustAmount){
        ...
        return createNewTenderMovement(safeLocation, tillLocation, tenderMovementType, tenderTypeId, tenderTypeName, adjustAmount)
    }
    ...
    private Integer createNewTenderMovement(uk.co.wonderlane.wlpos.reporting.Location tillLocation, uk.co.wonderlane.wlpos.reporting.Location safeLocation, TenderMovementType tenderMovementType, Integer tenderTypeId, String tenderTypeName, BigDecimal updateAmount){
