...
class TenderMovementService {
    ...
    void updateTenderLiftSafeSessionTotals(SafeSessionAction safeSessionAction, TenderType tenderType, BigDecimal updateAmount, int tenderMovementId, int safeId){
        User loggedInUser = loadLoggedInUser()
        shiftSafeSessionUpdate(safeId, tenderType, updateAmount) //Update safe session
        SafeSession safeSession = safeManagementService.getActiveSafeSession(safeId) //after update load safe session for audit purpose
   ...
   int tenderMovementUpdate(int tillId, int safeId, TenderMovementType tenderMovementType, TenderType tenderType, BigDecimal adjustAmount){
    ...
    private shiftSafeSessionUpdate(int safeId, TenderType tenderType, BigDecimal cashAmount) {
        ...
        safeManagementService.createNewSafeSessionWithTenderTotals(springSecurityService.principal.retailerId, springSecurityService.principal.storeId,
