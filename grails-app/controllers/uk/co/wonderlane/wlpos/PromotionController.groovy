...
class PromotionController {
    ...
    def save(PromotionCommand promotionCommand) {
        ...
        if (promotionCommand.validate() & validateChildren(promotionCommand)) {
            ...
            render (view: "add", model: [promotion: promotionCommand, promotionTypes: PromotionType.values(), canEdit: true, loyaltyEnabled: springSecurityService.principal.retailer.config?.loyaltyRetailerConfig?.isLoyaltyEnabled ? true : false])
        }
    }
