...
class PromotionController {
    ...
    def add() {
        ...
        [promotionTypes: PromotionType.values(), canEdit: true, loyaltyEnabled: loyaltyEnabled]
    ...
    def save(PromotionCommand promotionCommand) {
        ...
        if (promotionCommand.validate() & validateChildren(promotionCommand)) {
            ...
            render (view: "add", model: [promotion: promotionCommand, promotionTypes: PromotionType.values(), canEdit: true, loyaltyEnabled: loyaltyEnabled])
        }
    }
    ...
    def productSearch() {
        def products = productService.searchProductsHql(params.searchTerm, params.searchBy, params.max ? Integer.parseInt(params.max) : 50, params.offset ? Integer.parseInt(params.offset) : 0, "id", "asc", false, true)
