...
class ProductGroupController {
    ...
    def ajaxAddProductsFromCategory(int categoryId) {
        // Normally I'ld do this by a join, but.
        def products = Product.findAllByRetailerIdAndCategoryIdAndStatus(springSecurityService.principal.retailerId, categoryId, "ACTIVE")
