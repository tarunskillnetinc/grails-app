...
curl -u $2:$3 -X PUT "https://wonderlane.jfrog.io/artifactory/$repo/uk/co/wonderlane/wlpos/wlpos-back-office/$versionWithoutTimestamp/$1/wlpos-back-office-$version.jar" -T /builds/securetrading-gl/retail-platform/retail-platform/cloud-office/build/libs/build-$version.jar
