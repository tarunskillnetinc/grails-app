...
class SimpleMapJodaTimeMarshaller<T> extends AbstractMappingAwareCustomTypeMarshaller<T, Map, SimpleMapResultList> {
    ...
    @Override
    protected void queryInternal(PersistentProperty property, String key, org.grails.datastore.mapping.query.Query.PropertyCriterion criterion, SimpleMapResultList nativeQuery) {
